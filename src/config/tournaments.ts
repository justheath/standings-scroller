...
export const tournaments: TournamentConfig[] = [
  {
    ...
    description: "Our annual team tournament with a mix of scratch and handicap scoring, featuring both singles and doubles events.",
    csvUrl: "https://docs.google.com/spreadsheets/d/e/2PACX-1vQpNlgEre6fJCkz-cGIF5sh4tRPX9S58RwazK-kVe0shUnHpDCyrH0M88AiB83bix9skBLw3hhXR428/pub?gid=1111824680&single=true&output=csv",
  ...
  },
  {
    ...
    description: "A fun doubles tournament where partners alternate frames, combining their scores for a unique team dynamic.",
  ...
  },
  {
    slug: "twin-city-cup",
    name: "Twin City Cup",
    description: "End of season invitational tournament featuring the bowlers with the most individual points from the regular season, competing for the prestigious Twin City Cup.",
    csvUrl: "https://c-ubowl.com/wp-content/uploads/6/06/bowling.csv",
